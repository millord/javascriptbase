...
function Footer() {
  return __jsx("footer", {
    ...
    className: "mx-3 bg-black hover:bg-blue hover:text-blue border border-black text-white font-bold py-3 px-12 lg:px-8 duration-200 transition-colors mb-6 lg:mb-0",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
...
//# sourceMappingURL=index.js.747249455bb8ae7d0202.hot-update.js.map